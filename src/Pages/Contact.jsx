  ...
  const handleForm = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "http://ec2-3-6-89-177.ap-south-1.compute.amazonaws.com:4000/api/contact",
        {
          ...inputValue,
        },
  ...
  return (
    <>
      <div>
              ...
              <div className="flex items-center justify-center">
                <div className="px-2 md:px-12">
                  ...
                  <form onSubmit={handleForm} className="mt-8 space-y-4">
                    ...
                    <button
                      type="submit"
                      className="w-full rounded-md bg-cyan-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-cyan-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                    >
                      Send Message
                    </button>
                  </form>
        ...
        {/* greetings */}
        <div className="mt-16 flex items-center px-2 md:px-12">
        ...
        <div className="grid grid-cols-1 gap-4 gap-y-6 border-b border-gray-300 py-12 pb-20 md:grid-cols-2 lg:grid-cols-4 px-2 md:px-12">
          {users.map((user) => (
