        ...
        <div className="hidden lg:block">
          { !Cookies.get("token")
            ? <Link to={"/login"}>
              <button
                type="button"
                className="rounded-md bg-cyan-500 px-3 py-2 text-md font-bold text-white shadow-sm hover:bg-cyan-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
              >
                Login/Signup
              </button>
            </Link>
